...
// @ts-ignore
import exerciseImage from '../../assets/treinos/RemadaCurvada.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 4;

export default function RemadaCurvadaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[RemadaCurvadaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Remada Curvada</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Remada Curvada é um exercício composto realizado com barra ou halteres, com o tronco inclinado à frente.
            Foca no desenvolvimento do latíssimo do dorso, trapézio, deltoides posteriores e bíceps, além de recrutar
            o core para estabilidade. Ideal para ganhar força e definição na parte superior das costas.
          </Text>
        </View>
      </View>
