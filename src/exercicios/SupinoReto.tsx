...
// @ts-ignore
import exerciseImage from '../../assets/treinos/SupinoReto.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 7;

export default function SupinoRetoScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[SupinoRetoScreen] erro:', error);
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Supino Reto é um exercício fundamental para o desenvolvimento do peitoral maior, tríceps e deltoides
            anteriores. Realizado deitado em banco plano segurando uma barra, promove força e hipertrofia da parte
            superior do corpo, melhorando a estabilidade do tronco e a postura.
          </Text>
        </View>
      </View>
