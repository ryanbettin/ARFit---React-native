...
// @ts-ignore
import exerciseImage from '../../assets/treinos/TricepsTesta.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 13;

export default function TricepsTestaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[TricepsTestaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Tríceps Testa</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Tríceps Testa é um exercício de extensão de cotovelo realizado deitado em banco reto ou inclinado,
            segurando uma barra ou halteres acima da testa. Trabalha principalmente as três cabeças do tríceps,
            ajudando no desenvolvimento de força e definição na parte posterior do braço.
          </Text>
        </View>
      </View>
