...
// @ts-ignore
import exerciseImage from '../../assets/treinos/CadeiraExtensora.png';
const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 3;

export default function CadeiraExtensoraScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[CadeiraExtensoraScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Cadeira Extensora</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Cadeira Extensora é um exercício realizado em equipamento específico que foca no fortalecimento dos
            quadríceps, estabiliza a articulação do joelho e contribui para a definição muscular das coxas.
            Pode ser ajustada em carga conforme o nível de treino, sendo indicada tanto para iniciantes quanto para
            atletas avançados.
          </Text>
        </View>
      </View>
