...
// @ts-ignore
import exerciseImage from '../../assets/treinos/Prancha.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 20;

export default function PranchaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[PranchaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Prancha</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Prancha é um exercício isométrico que fortalece o core, atuando nos músculos abdominais, lombares e estabilizadores do tronco. 
            Ao manter o corpo reto apoiado nos antebraços e pontas dos pés, melhora a postura, estabilidade e resistência muscular, sendo indicada para todos os níveis de treino.
          </Text>
        </View>
      </View>
