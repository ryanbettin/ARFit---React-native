...
// @ts-ignore
import exerciseImage from '../../assets/treinos/RemadaAlta.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 18;

export default function RemadaAltaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[RemadaAltaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Remada Alta</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Remada Alta é um exercício de puxada vertical com barra ou halteres, focado nos músculos trapézio,
            deltoides posteriores e parte superior do dorso. Auxilia no desenvolvimento de força e definição das costas,
            além de melhorar a postura e a estabilidade de ombros e tronco.
          </Text>
        </View>
      </View>
