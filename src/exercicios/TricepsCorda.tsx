...
// @ts-ignore
import exerciseImage from '../../assets/treinos/TricepsCorda.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 14;

export default function TricepsCordaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[TricepsCordaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Tríceps Corda</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Tríceps Corda é um exercício de extensão de cotovelo realizado em polia alta com pegada na corda.
            Trabalha as três cabeças do tríceps, promovendo força e definição na parte posterior do braço.
            Mantenha o tronco estável e os cotovelos próximos ao corpo durante todo o movimento.
          </Text>
        </View>
      </View>
