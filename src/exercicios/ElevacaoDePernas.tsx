...
// @ts-ignore
import exerciseImage from '../../assets/treinos/ElevacaoDePernas.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 21;

export default function ElevacaoDePernasScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[ElevacaoDePernasScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Elevação de Pernas</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Elevação de Pernas fortalece a musculatura abdominal inferior e os flexores do quadril. Geralmente
            realizada deitada em um banco ou suspensa em barras, este exercício também auxilia na estabilidade do core
            e no controle postural. Pode ser adaptado para diferentes níveis de treino, aumentando amplitude ou carga.
          </Text>
        </View>
      </View>
