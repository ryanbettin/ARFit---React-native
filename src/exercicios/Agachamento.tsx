...
// @ts-ignore
import exerciseImage from '../../assets/treinos/Agachamento.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 1;

export default function AgachamentoScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[AgachamentoScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Agachamento</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Agachamento é um exercício fundamental para o fortalecimento dos músculos dos membros inferiores
            (quadríceps, glúteos e isquiotibiais). Além disso, melhora a estabilidade do core, auxilia na postura
            e no equilíbrio, e pode ser adaptado a diferentes níveis de treino e variações de carga.
          </Text>
        </View>
      </View>
