...
// @ts-ignore
import exerciseImage from '../../assets/treinos/Mergulho.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 15;
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[MergulhoScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Mergulho</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Mergulho (dip) é um exercício de peso corporal que foca principalmente no tríceps e no peitoral inferior.
            Realizado em paralelas ou entre bancos, também recruta ombros e core, sendo excelente para desenvolver força
            e definição da parte superior do corpo.
          </Text>
        </View>
      </View>
