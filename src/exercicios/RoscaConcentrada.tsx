...
// @ts-ignore
import exerciseImage from '../../assets/treinos/RoscaConcentrada.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 12;

export default function RoscaConcentradaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[RoscaConcentradaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Rosca Concentrada</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Rosca Concentrada é um exercício de isolamento para bíceps, realizado sentado com apoio do braço em uma
            coxa. Foca no pico do bíceps braquial, melhora a conexão mente-músculo e permite máxima contração,
            sendo ideal para definição e força em membros superiores.
          </Text>
        </View>
      </View>
