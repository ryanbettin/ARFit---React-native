...
// @ts-ignore
import exerciseImage from '../../assets/treinos/LegPress.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 2;

export default function LegPressScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[LegPressScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Leg Press</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Leg Press é um exercício de máquina que trabalha principalmente os quadríceps, glúteos e isquiotibiais.
            Promove fortalecimento e hipertrofia dos membros inferiores, melhora a estabilidade do joelho e auxilia na
            postura. Pode ser ajustado em carga e amplitude de movimento para diferentes níveis de treino.
          </Text>
        </View>
      </View>
