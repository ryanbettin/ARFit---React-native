...
// @ts-ignore
import exerciseImage from '../../assets/treinos/RoscaMartelo.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 11;

export default function RoscaMarteloScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[RoscaMarteloScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Rosca Martelo</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Rosca Martelo é um exercício de isolamento para bíceps e braquiorradial, realizado em pé com halteres
            em pegada neutra (palmas voltadas uma para a outra). Auxilia no desenvolvimento do pico do bíceps e
            fortalece o antebraço, sendo excelente para definição e força dos membros superiores.
          </Text>
        </View>
      </View>
