...
// @ts-ignore
import exerciseImage from '../../assets/treinos/AbdominalSupra.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 19;
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[ExercicioScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Abdominal Supra</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Abdominal Supra fortalece os músculos retos do abdômen, melhora a postura e auxilia na definição da cintura. Pode ser feito por todos os níveis de treino e é essencial para estabilidade do core.
          </Text>
        </View>
      </View>
