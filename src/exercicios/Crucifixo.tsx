...
export default function CrucifixoScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[CrucifixoScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Crucifixo</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Crucifixo é um exercício essencial para trabalhar os músculos peitorais, promovendo abertura de peitoral
            e definição da região. Realizado geralmente em banco plano com halteres, fortalece o peitoral maior e auxilia
            na estabilidade do ombro, sendo indicado para todos os níveis de treino.
          </Text>
        </View>
      </View>
