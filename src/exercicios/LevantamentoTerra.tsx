...
// @ts-ignore
import exerciseImage from '../../assets/treinos/LevantamentoTerra.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 6;

export default function LevantamentoTerraScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[LevantamentoTerraScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Levantamento Terra</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            O Levantamento Terra é um exercício composto que trabalha a cadeia posterior, incluindo glúteos,
            isquiotibiais, lombar e quadríceps. Realizado com barra desde o chão, fortalece a força de corpo
            inteiro e a estabilidade do core, sendo fundamental para ganhos de massa e resistência muscular.
          </Text>
        </View>
      </View>
