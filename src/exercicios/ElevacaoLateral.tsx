...
// @ts-ignore
import exerciseImage from '../../assets/treinos/ElevacaoLateral.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 17;

export default function ElevacaoLateralScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[ElevacaoLateralScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Elevação Lateral</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Elevação Lateral foca no desenvolvimento dos deltoides laterais, promovendo ombros mais largos e
            definidos. Geralmente executada com halteres ou cabos, em pé ou sentado, melhora a estabilidade do ombro
            e auxilia na postura, sendo indicada para todos os níveis de treino.
          </Text>
        </View>
      </View>
