...
// @ts-ignore
import exerciseImage from '../../assets/treinos/RoscaDireta.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 10;

export default function RoscaDiretaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[RoscaDiretaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Rosca Direta</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Rosca Direta é um exercício clássico de isolamento para bíceps, realizado em pé com barra ou halteres.
            Foca no desenvolvimento do bíceps braquial e braquiorradial, melhora a força e define a parte frontal dos
            braços. Pode ser executada com pegada supinada para máxima contração.
          </Text>
        </View>
      </View>
