...
// @ts-ignore
import exerciseImage from '../../assets/treinos/FlexaoDeBraco.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 9;

export default function FlexaoDeBracoScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[FlexaoDeBracoScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Flexão de Braço</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Flexão de Braço é um exercício clássico de peso corporal que trabalha principalmente o peitoral,
            tríceps e deltoides anteriores. Além de fortalecer o core e melhorar a estabilidade do tronco,
            pode ser adaptada para todos os níveis de treino variando apoio de joelhos, largura das mãos ou inclinação.
          </Text>
        </View>
      </View>
