...
// @ts-ignore
import exerciseImage from '../../assets/treinos/PuxadaAlta.png';

const PRIMARY_COLOR = '#0776A0';
const BACKGROUND = '#FFFFFF';
const EXERCISE_ID = 5;

export default function PuxadaAltaScreen() {
  ...
  const handleNext = async () => {
    if (step === 1) {
      ...
      try {
        ...
        console.error('[PuxadaAltaScreen] erro:', error);
  ...
  return (
    <SafeAreaView style={styles.wrapper}>
      <View style={styles.header}>
        ...
        <Text style={styles.title}>Puxada Alta</Text>
      </View>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.descriptionContainer}>
          <Text style={styles.description}>
            A Puxada Alta é um exercício de puxada vertical, geralmente realizado em máquina ou polia alta, que foca no
            fortalecimento do latíssimo do dorso. Também recruta bíceps, trapézio e deltoides posteriores, ajudando no
            desenvolvimento de largura e definição das costas, além de melhorar a postura e a estabilidade do tronco.
          </Text>
        </View>
      </View>
